...
<div class="container">
	<div class="card shadow-sm mt-5">
        <div class="card-header">
            <h4>Benvenuto Admin <%=username %></h4>
        </div>
        <div class="card-body">
            <div class="row mb-3">
				<div class="col-md-6">
            ...
            <div class="row my-4 justify-content-evenly">
                ...
                <div class="col-md-3 text-center">
                	<a class="btn" href="/<%= application.getServletContextName() %>/admin/progetti.jsp">
                ...
                <div class="col-md-3 text-center">
                	<a class="btn" href="/<%= application.getServletContextName() %>/admin/pagamenti.jsp">
