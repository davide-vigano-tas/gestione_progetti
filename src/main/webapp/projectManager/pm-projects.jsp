        ...
        <div class="card-body">
            ...
            <div class="row my-4 justify-content-evenly">
                <div class="col-md-3 text-center">
                	<a class="btn" href="projectForm.jsp">
            	...
            	<table class="table table-striped" id="tabella">
               		...
               		<tbody>
               			...
               			<tr>
               				...
               				<td><%=projects.get(i).getPercentualeCompletamento() %></td>
               				<td><%=ProjectManagerFacade.getInstance().getProjectManagerById(projects.get(i).getIdCliente()).getEmail() %></td>
               				<td><%=ProjectManagerFacade.getInstance().getProjectManagerById(projects.get(i).getIdResponsabile()).getEmail() %></td>
               				<td><%=projects.get(i).getBudget() %></td>
               				<td><%=projects.get(i).getCostoProgetto() %></td>
